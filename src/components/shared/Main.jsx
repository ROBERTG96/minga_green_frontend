    ...
    <div>
                ...
                <div className="flex justify-between h-64 bg-home1 rounded bg-cover w-full">
                  ...
                  <div className="flex">
                    ...
                    <div className="flex p-24 items-center md:p-5 md:text-xs md:items-start lg:-mx-32 lg:p-7 lg:pr-32 2xl:-mx-32">
                      <h1 className="text-white my-2 text-sm font-thin xl:w-[90%] xl:pl-16 xl:pt-4 xl:leading-tight 2xl:pl-44">
                        <h1 className="text-white text-xl my-4 lg:text-2xl">Shonen</h1>
        ...
        <div className="hidden md:block container mx-auto p-10 -mt-12">
          <div className="h-[551px] rounded bg-desktop bg-cover w-full bg-center my-6 flex flex-col justify-center p-24">
            <div className="my-10">
              <h1 className="text-white md:text-3xl md:flex md:mt-32 lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold">
        ...
        <div className="flex md:hidden justify-between overflow-hidden bg-[#EBEBEB]">
          <div className="md:w-[400px] md:hidden bg-mobile mx-auto w-full h-screen bg-center bg-cover">
            <NavBar></NavBar>
            <div className="flex flex-col justify-center my-52 items-center">
              <h1 className="text-white my-2 pl-9 pr-6 text-center text-4xl sm:text-4xl font-bold">
                Live the emotion of the manga
              </h1>
              <h1 className="text-white text-2xl my-2 mb-4">
                Find the perfect manga for you
              </h1>
              <button className="p-4 w-80 rounded-full text-white text-lg font-medium bg-[#F472B6]">
                Explore
              </button>
            </div>
          </div>
